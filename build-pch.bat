...
:DEBUG
echo debug
cl %CompilerFlags% /Fo%obj% /Fe%executable% /Ycpch.h /Fd%pdb% /I src /I dependencies/include pch.cpp /D __WINDOWS__ /link /ignore:4099 /LIBPATH:dependencies/lib %Libs% %*
GOTO END
