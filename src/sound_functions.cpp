...
void output_test_wave(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
...
void output_sine_wave(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
    int wave_period = (int)(info.samples_per_second / globals->tone_hz);
...
void output_square_wave(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
    int wave_period = (int)(info.samples_per_second / globals->tone_hz);
...
void output_half_square_wave(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
    int wave_period = (int)(info.samples_per_second / globals->tone_hz);
...
void output_triangle_wave(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
    int wave_period = (int)(info.samples_per_second / globals->tone_hz);
...
void output_saw_wave(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
    int wave_period = (int)(info.samples_per_second / globals->tone_hz);
...
void add_by_osc2(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
    int wave_period = (int)(info.samples_per_second / globals->tone_hz);
...
void amplitude_mod(Globals* globals, Sample_Info info) {
    static f64 t_sine = 0;
    int wave_period = 1;
...
void pan_mod(Globals* globals, Sample_Info info)
{
    static f64 t_sine = 0;
